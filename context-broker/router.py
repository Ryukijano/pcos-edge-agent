...
def route(task: Task) -> RoutingDecision:
    ...
    # Private or offline tasks → Android LiteRT-LM
    ...
    # Short browser-grounded transform tasks → Chrome Built-in AI
    ...
    # Personal context tasks → PiecesOS first
    ...
    # Function/tool calls → FunctionGemma on device
    ...
    # Long reasoning or oversized context → Cloud escalation
